...
public class LoanManagementController {
	...
	/**
	 * Applies for a loan based on the given details
	 * 
	...
	/**
	 * Gets the loan application status given the customer id
	 * 
	 * @param custId customer id of the user
	 * @return list of loan application
	 */
	...
	/**
	 * Gets the details of the all the applied loans
	 * 
