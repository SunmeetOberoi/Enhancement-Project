...
public class LoanManagementServiceImpl implements LoanManagementService {
	...
	/**
	 * Gets the details of a customers loan
	 */
	@Override
	...
	public ResponseEntity<String> approveLoan(Integer applicationId) {
		...
		customerLoan.setCustomerId(app.getCustomerId());
		customerLoan.setLoanPrincipal(app.getLoanAmount());
		customerLoan.setTenure(app.getTenure());
		customerLoan.setInterest(12.5);
		customerLoan.setEmi(emi);
		customerLoan.setCollateralId(cId);
		System.out.println(customerLoanRepo.save(customerLoan));
